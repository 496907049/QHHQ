 ...
 * 修改备注：
 */
public class InternationalFormAdapter extends BaseQuickAdapter<InternationalForm, BaseViewHolder> {

    public InternationalFormAdapter(@LayoutRes int layoutResId, @Nullable List<InternationalForm> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, InternationalForm item) {
