 ...
 * 修改备注：
 */
public class MacroscopicAdapter extends BaseQuickAdapter<Macroscopic, BaseViewHolder> {

    public MacroscopicAdapter(@LayoutRes int layoutResId, @Nullable List<Macroscopic> data) {
