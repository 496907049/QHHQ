 ...
 * 修改备注：
 */
public class FederalReserveAdapter extends BaseQuickAdapter<FederalReserve, BaseViewHolder> {

    public FederalReserveAdapter(@LayoutRes int layoutResId, @Nullable List<FederalReserve> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, FederalReserve item) {
