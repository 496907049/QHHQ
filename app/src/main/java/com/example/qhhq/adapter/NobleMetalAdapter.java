 ...
 */
public class NobleMetalAdapter extends BaseQuickAdapter<NobleMetal, BaseViewHolder> {
    public NobleMetalAdapter(int layoutResId, List data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, NobleMetal item) {
