 ...
 * 修改备注：
 */
public class ForeignExchange2Adapter extends BaseQuickAdapter<ForeignExchange, BaseViewHolder> {

    public ForeignExchange2Adapter(@LayoutRes int layoutResId, @Nullable List<ForeignExchange> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, ForeignExchange item) {
