...
public class SimpleCardFragment2 extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public static SimpleCardFragment2 getInit( ) {
   ...
   /* 初始化外汇控件 */
    ...
    public void getInfoList() {
        String url =  Contants.HANG_PING_HTTP_BASE2;
