...
public class SimpleCardFragment7 extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public static SimpleCardFragment7 getInit( ) {
        SimpleCardFragment7 sf = new SimpleCardFragment7();
        return sf;
    }
   ...
   /* 初始化外汇控件 */
    ...
    public void getInfoList() {
        String url =  Contants.HANG_PING_HTTP_BASE7;
