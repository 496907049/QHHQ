...
public class SimpleCardFragment4 extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public static SimpleCardFragment4 getInit( ) {
   ...
   /* 初始化外汇控件 */
    ...
    public void getInfoList() {
        String url =  Contants.HANG_PING_HTTP_BASE4;
