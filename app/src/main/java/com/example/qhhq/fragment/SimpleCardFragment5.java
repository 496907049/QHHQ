...
public class SimpleCardFragment5 extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public static SimpleCardFragment5 getInit( ) {
        SimpleCardFragment5 sf = new SimpleCardFragment5();
        return sf;
    }
   ...
   /* 初始化外汇控件 */
    ...
    public void getInfoList() {
        String url =  Contants.HANG_PING_HTTP_BASE5;
