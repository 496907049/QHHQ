...
public class SimpleCardFragment6 extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public static SimpleCardFragment6 getInit( ) {
        SimpleCardFragment6 sf = new SimpleCardFragment6();
        return sf;
    }
   ...
   /* 初始化外汇控件 */
    ...
    public void getInfoList() {
        String url =  Contants.HANG_PING_HTTP_BASE6;
