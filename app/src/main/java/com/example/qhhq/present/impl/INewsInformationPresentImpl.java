...
public class INewsInformationPresentImpl implements INewsInformationPresent {

    private Context context;
    private INewsInformationView newsInformationView;

    public INewsInformationPresentImpl(INewsInformationView newsInformationView, Context context) {
        this.context = context;
        this.newsInformationView = newsInformationView;
    }

    @Override
    public void getInfoList(int markId, int num, int tagId) {
        String url = Contants.NEWS_INFORMATION_HTTP_BASE;
        ...
        HttpClientUtil.getInstance(context).post(context,url,params,new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                List<NewsInformation> beanList= new ArrayList<>();
...
//                        JSONObject root = new JSONObject(Info.getString("root"));
                        ...
                        newsInformationView.showInfoList(beanList);
                    }
...
//                        JSONObject root = new JSONObject(Info.getString("root"));
                        ...
                        newsInformationView.showLoadMoreInfoList(beanList);
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
